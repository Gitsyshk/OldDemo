...
import com.zoe.framework.gl.Vertices;
...
public class BlendingTest extends GLGame {
	...
	class BlendingScreen extends Screen {
		...
		public BlendingScreen(Game game) {
			...
			float[] rects = new float[] { 100, 100, 1, 1, 1, 0.5f, 0, 1, 228,
					100, 1, 1, 1, 0.5f, 1, 1, 228, 228, 1, 1, 1, 0.5f, 1, 0,
					100, 228, 1, 1, 1, 0.5f, 0, 0,

					100, 300, 1, 1, 1, 1, 0, 1, 228, 300, 1, 1, 1, 1, 1, 1,
					228, 428, 1, 1, 1, 1, 1, 0, 100, 428, 1, 1, 1, 1, 0, 0 };
			vertices.setVertices(rects, 0, rects.length);
			vertices.setIndices(new short[] { 0, 1, 2, 2, 3, 0, 4, 5, 6, 6, 7,
					4 }, 0, 12);
		}
		@Override
