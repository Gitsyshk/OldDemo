...
public class Renew_3 extends Thread {
	private String path = "http://m.weather.com.cn/data/";
	private MyApplication application;

	public Renew_3(MyApplication application) {
	...
	public void run() {
		while (true) {
			try {
				...
				br.close(); // 关闭
				isr.close(); // 关闭
				application.myData_3 = DataTool.formJson_3(html.toString());
				Thread.sleep(1000);
			} catch (Exception e) {
				e.printStackTrace();
			}
